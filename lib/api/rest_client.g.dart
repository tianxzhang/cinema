...
class _RestClient implements RestClient {
  ...
  @override
  Future<MoviesResponse> getMoviesForGenre(withGenres) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'with_genres': withGenres};
  ...
  @override
  Future<MoviesResponse> searchMovie(query) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<ArtistsResponse> getArtists(id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ArtistsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ArtistsResponse.fromJson(_result.data!);
    return value;
  }
